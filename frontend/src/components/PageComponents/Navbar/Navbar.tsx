...
const Navbar = (props: any) => {
  return (
    <section className="flex justify-center">
      <div className="w-[90%] rounded-lg fixed m-auto px-10 py-5 flex justify-between items-center z-[30] backdrop-filter backdrop-blur-lg bg-opacity-50 shadow-border ">
        <Logo />
